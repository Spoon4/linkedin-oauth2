...
require_once( plugin_dir_path( __FILE__ ) . 'includes/api/class-linkedin-user.php' );

require_once( plugin_dir_path( __FILE__ ) . 'includes/api/datastore/class-linkedin-datastore.php' );
